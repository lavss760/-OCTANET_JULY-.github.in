    ...
    footer.innerHTML = `
        <div class="footer-container">
            <div class="footer-section">
                <h3>About Us</h3>
                <p>REVIEWER'S POINT is a dedicated platform where customers share honest and detailed reviews of various products to help others make informed purchasing decisions.</p>
            </div>
            <div class="footer-section">
                <h3>Quick Links</h3>
                <ul>
